...
/*  o2w->Translate(10,10,10); */
  ...
  Vector<Point3D> p ( { Point3D( 1, 0, 0 ), Point3D( 0, 1, 0 ), Point3D( 0, 0, 1 ), Point3D( 1, 1, 1 ) });

/*  Normal n[4] = {Normal(2,1,1),Normal(1,2,1),Normal(1,1,2),Normal(2,2,2)}; */
  Vector<size_t> vi ({ 2, 1, 0, 0, 1, 3, 1, 2, 3, 3, 2, 0 });
  shared_ptr< TriangleMesh > mesh( new TriangleMesh( o2w.get( ), w2o.get( ), false, vi, p /*, n*/ ) );
